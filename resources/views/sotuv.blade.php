            ...
            <div class="extr25552 scrolll2">
                <div class="row">
                    ...
                    <div class="col-3 mt-3 ">
                        <a class="d-flex"><h5>Клент имя:</h5> <h4 class="clnam mx-3"></h4></a>
                    </div>
...
<div class="card col-4">
    <div class="card-header">
        <input type="hidden" id="onval" value="0">
          <div class="row col-5">
            <input type="text" name="search" id="searchclent" class="form-control" placeholder="Поиск" />
        </div>
    </div>
        <div class="table-responsive mailbox-messages">
            <div class="extr25552 scrolll2">
...
<div class="modal-dialog">
  <div class="modal-content">
    ...
    <div class="modal-body">
            ...
            <input type="hidden" name="clentra" id="clentra">
            <div class="mb-3 d-flex">
                <div class="col-4">
...
<div class="page-body button-page">
    ...
    <div class="card col-2">
        @if ($itogsdok)
            ...
            <input type="text" name="id" id="itogdok" class="form-control text-right" disabled value="{{ $itogsdok->itogo }}">
            <label for="message-text" class="col-form-label m-0 text-right">Курс</label>
            <input type="text" id="kursdok" class="form-control text-right" disabled value="{{ $itogsdok->kurs }}">
            <button onclick="kursmdok()" id="kursmdok" class="btn btn-dark mt-1 m-0">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-currency-dollar" viewBox="0 0 16 16">
                    <path d="M4 10.781c.148 1.667 1.513 2.85 3.591 3.003V15h1.043v-1.216c2.27-.179 3.678-1.438 3.678-3.3 0-1.59-.947-2.51-2.956-3.028l-.722-.187V3.467c1.122.11 1.879.714 2.07 1.616h1.47c-.166-1.6-1.54-2.748-3.54-2.875V1H7.591v1.233c-1.939.23-3.27 1.472-3.27 3.156 0 1.454.966 2.483 2.661 2.917l.61.162v4.031c-1.149-.17-1.94-.8-2.131-1.718H4zm3.391-3.836c-1.043-.263-1.6-.825-1.6-1.616 0-.944.704-1.641 1.8-1.828v3.495l-.2-.05zm1.591 1.872c1.287.323 1.852.859 1.852 1.769 0 1.097-.826 1.828-2.2 1.939V8.73l.348.086z"/>
                  </svg>
            </button>
        @else
            <label for="message-text" class="col-form-label m-0 text-right">Итого</label>
            <input type="text" id="itog2dok" class="form-control text-right" disabled value="0">
            <label for="message-text" class="col-form-label m-0 text-right">Курс</label>
            <input type="text" id="kurs2dok" class="form-control text-right" disabled>
...
<div class="modal-dialog">
  <div class="modal-content">
    ...
    <div class="modal-footer">
      <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" id="nazaddok">Назад</button>
      <button type="submit" class="btn btn-primary" id="saqlashdok">Сохранить</button>
    </div>
...
<div class="modal-dialog">
  <div class="modal-content">
    ...
    <div class="modal-footer">
      <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" id="nazaddok">Назад</button>
      <button type="submit" class="btn btn-primary" id="usdkurd2dok">Сохранить</button>
    </div>
...
<div class="modal-footer">
    ...
    <button id="SubmitCkickeddok" class="btn btn-primary">Сохранить</button>
</div>
</div>
...
<div class="modal-dialog">
  <div class="modal-content">
    <div class="modal-header">
      ...
      <div class="text-center pb-4 pt-4">
          <button type="button" class="btn btn-primary mx-4" id="zzzzdok">Бирламчи</button>
          <button type="submit" id="zzzz2dok" class="btn btn-success">Дойимий</button>
      </div>
  </div>
</div>
</div>
...
//   $("#tulov").html('<div class="mb-3 d-flex"><div class="col-4"><h5 class="mt-2 mx-2">Наличные:</h5></div><div class="col-6"><input type="text" class="form-control text-right itogsw" name="naqt" id="naqt"></div><div class="col-2"><button class="btn btn-success" id="naqtteng">=</button></div></div><div class="mb-3 d-flex"><div class="col-4"><h5 class="mt-2 mx-2">Карта:</h5></div><div class="col-6"><input type="text" class="form-control text-right itogsw" name="plastik" id="plastik"></div><div class="col-2"><button class="btn btn-success" id="plastikteng">=</button></div></div><div class="mb-3 d-flex"><div class="col-4"><h5 class="mt-2 mx-2">Банк:</h5></div><div class="col-6"><input type="text" class="form-control text-right itogsw" name="bank" id="bank"></div><div class="col-2"><button class="btn btn-success" id="bankteng">=</button></div></div>');
  ...
  $( function() {
    ...
    $(document).on("click", "#clbelgilash", function(){
        var id = $(this).data("id");
...
function kursm(){
    ...
    $(document).ready(function(){
        ...
        $(document).on('keyup', '#naqt', function(){
            ...
            if(kar < 0){
                toastr.error("Толов коп толанди");
                var inputdate = "<span class='mt-2'>Срок дате:</span><input type='date' class='form-control' id='srokdok' />";
                $("#channgem").html(inputdate);
            }
            if(kar == 0){
    ...
    $(document).ready(function(){
        ...
        $("#tayyor").on('click', function(){
            ...
            if (clentra) {
                ...
                toastr.error("Клент выберите").fadeOut(2500);
            }
        });

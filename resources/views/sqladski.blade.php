...
@else
<div id="AAAAAAAA2" class="card ui-widget-content">
    <div class="card-block tab-icon">
            <div class="col-12">
                <ul class="nav nav-tabs md-tabs " role="tablist">
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#messages7dok" role="tab" aria-expanded="false"><i class="icofont icofont-ui-message"></i>Итого</a>
                        <div class="slide"></div>
                    </li>
                </ul>
                <div class="tab-content card-block">
                    <div class="tab-pane active" id="home7dok" role="tabpanel" aria-expanded="true">
                            ...
                            <div class="card col-1">
                                <button id="decirementedok" class="btn btn-info mt-1 m-0">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
                                        <path fill-rule="evenodd" d="M8 2a.5.5 0 0 1 .5.5v5h5a.5.5 0 0 1 0 1h-5v5a.5.5 0 0 1-1 0v-5h-5a.5.5 0 0 1 0-1h5v-5A.5.5 0 0 1 8 2Z"/>
                                      </svg>
                                </button>
                                <button id="incerementedok" class="btn btn-danger mt-1 m-0">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-dash" viewBox="0 0 16 16">
                                        <path d="M4 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 4 8z"/>
                                      </svg>
                                </button>
                                <button id="yangilashdok" class="btn btn-warning mt-1 m-0" style="color: black;">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-pen-fill" viewBox="0 0 16 16">
                                        <path d="m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001z"/>
                                      </svg>
                                </button>
                                <button id="udalitdok" class="btn btn-danger mt-1 m-0">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
                                        <path d="M11 1.5v1h3.5a.5.5 0 0 1 0 1h-.538l-.853 10.66A2 2 0 0 1 11.115 16h-6.23a2 2 0 0 1-1.994-1.84L2.038 3.5H1.5a.5.5 0 0 1 0-1H5v-1A1.5 1.5 0 0 1 6.5 0h3A1.5 1.5 0 0 1 11 1.5Zm-5 0v1h4v-1a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5ZM4.5 5.029l.5 8.5a.5.5 0 1 0 .998-.06l-.5-8.5a.5.5 0 1 0-.998.06Zm6.53-.528a.5.5 0 0 0-.528.47l-.5 8.5a.5.5 0 0 0 .998.058l.5-8.5a.5.5 0 0 0-.47-.528ZM8 4.5a.5.5 0 0 0-.5.5v8.5a.5.5 0 0 0 1 0V5a.5.5 0 0 0-.5-.5Z"/>
                                      </svg>
                                </button>
                    ...
                    <div class="tab-pane" id="messages7dok" role="tabpanel" aria-expanded="false">
                      <div class="table-responsive">
                          <div class="card-header">
                              <div class="card-header-left col-5 ml-0 pl-0 d-flex">
                                  <input type="search" id="sqladsearchdok" class="form-control ml-0" placeholder="Search">
                                  <input type="date" name="date" id="date1dok" class="form-control mx-2">
                                  <input type="date" name="date2" id="date2dok" class="form-control">
                              </div>
                          </div>
                        <div class="epam scrolll2">
                            <div class="rty2">
  ...
  <div class="modal fade" id="zaqazaytModaldok" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <input type="number" name="son" id="sondok" class="form-control">
          </div>
          <div class="modal-footer">
              <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Назад</button>
              <button id="buttondok" class="btn btn-primary">Сохранить</button>
          </div>
      </div>
    </div>
  </div>

  <div class="modal fade" id="zaqazay0dok" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Товарни очириш</h5>
          ...
          <div class="text-center pb-4">
              <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Нет</button>
              <button id="udalit2dok" class="btn btn-success">Да</button>
          </div>
      </div>
    </div>
  </div>

  <div class="modal fade" id="zaqazaytModal2dok" tabindex="-1" aria-labelledby="exampleModalLabeldok" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabeldok">Товарларни жонатмокчимисиз</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
          <div class="text-center pb-4">
              <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Нет</button>
              <button id="tayyor2dok" class="btn btn-success">Да</button>
          </div>
      </div>
    </div>
  </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        fetch_customer_data3dok();
        function fetch_customer_data3dok(query = '')
        {
            $.ajax({
                url:"{{ route('tbody3tabledok') }}",
                method:'GET',
                data:{query:query},
                dataType:'json',
                success:function(data)
                {
                    $('#tbody3dok').html(data.table_data);
                }
            });
        }

        $(document).on('keyup', '#sqladsearchdok', function(){
            var query = $(this).val();
            fetch_customer_data3dok(query);
        });

       $(document).on('change', '#date1dok', function(){
            var date1 = $("#date1dok").val();
            var date2 = $("#date2dok").val();
            $.ajax({
                url:"{{ route('tbody3table2dok') }}",
                method:'GET',
                data:{
                    date1: date1,
                    date2: date2
        ...
        $(document).on('click', "#asdsaddok", function(){
            let _token   = $('meta[name="csrf-token"]').attr('content');
            var id = $(this).data("id");
            $.ajax({
                url:"{{ route('malumotolishdok') }}",
                method:'GET',
                data:{
                    id: id,
                    _token: _token
                ...
                success:function(data)
                {
                    $("#radiodok").val(data.id);
                    $("#innerdok").html(data.name);
                }
            });
        });

        $(document).on('click', "#decirementedok", function(){
            let _token   = $('meta[name="csrf-token"]').attr('content');
            var id = $("#radiodok").val();
            $.ajax({
                url:"{{ route('plussqladdok') }}",
                method:'POST',
                data:{
                    id: id,
                    _token: _token
                ...
                {
                    if(data.status == 0){
                        $("#radiodok").val(data.data.id);
                        $("#innerdok").html(data.data.name);
                        toastr.error("Товар етарли емас").fadeOut(1500);
                    }else{
                        fetch_customer_data2dok();
                        $("#radiodok").val(data.data.id);
        ...
        $(document).on('click', "#incerementedok", function(){
            let _token   = $('meta[name="csrf-token"]').attr('content');
            var id = $("#radiodok").val();
            $.ajax({
                url:"{{ route('minussqladdok') }}",
                method:'POST',
                data:{
                    id: id,
                    _token: _token
        ...
        $(document).on('click', "#udalitdok", function(){
            $("#zaqazay0dok").modal("show");
        });

        $(document).on('click', "#udalit2dok", function(){
            let _token   = $('meta[name="csrf-token"]').attr('content');
            var id = $("#radiodok").val();
            $.ajax({
                url:"{{ route('udalitsqladdok') }}",
                method:'POST',
                data:{
                    id: id,
                    _token: _token
                ...
                success:function(data)
                {
                    ...
                    $("#radiodok").val('');
                    $("#innerdok").html('')
                    $("#zaqazay0dok").modal("hide");
                    toastr.error("Товар очирилди").fadeOut(1500);                
                }
            });
        });

        $(document).on('click', "#yangilashdok", function(){
            let _token   = $('meta[name="csrf-token"]').attr('content');
            var id = $("#radiodok").val();
            if(id){
                $.ajax({
                    url:"{{ route('yangilashsqladdok') }}",
                    method:'GET',
                    data:{
                        id: id,
                        _token: _token
        ...
        $(document).on('click', "#buttondok", function(){
            let _token   = $('meta[name="csrf-token"]').attr('content');
            var id = $("#radiodok").val();
            var son = $("#sondok").val();
            $.ajax({
                url:"{{ route('saqlashsqladdok') }}",
                method:'POST',
                data:{
                    id: id,
                    son: son,
        ...
        $(document).on('click', "#tayyordok", function(){
            $("#zaqazaytModal2dok").modal("show");
        })

        $(document).on('click', "#tayyor2dok", function(){
            let _token = $('meta[name="csrf-token"]').attr('content');       
            $.ajax({
                url:"{{ route('tayyorsqladdok') }}",
                method:'POST',
                data:{
                    _token: _token
                },
